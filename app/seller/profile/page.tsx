      ...
      <div className="space-y-6">
        ...
        <div className="rounded-2xl border bg-white p-6 text-sm shadow-sm">
          <div className="grid gap-3 md:grid-cols-2">
            ...
            <p>
              <span className="font-semibold">{t('Badge', 'Badge')}:</span>{' '}
              {trust?.hasBadge
            ...
            <p>
              <span className="font-semibold">{t('Profil public IA', 'AI public profile')}:</span>{' '}
              {trust?.profileAccessible ? t('Accessible', 'Accessible') : t('Non valide', 'Not validated')}
            </p>
          ...
          <p className="mt-4 rounded-xl bg-slate-50 p-3 text-slate-600">{seller?.about}</p>

          <Link href="/profile" className="mt-5 inline-block rounded-lg bg-dark px-4 py-2 font-semibold text-white">
